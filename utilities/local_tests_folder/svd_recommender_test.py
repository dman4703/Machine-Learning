...
class SVDRecommender_Test:
    ...
    def __init__(
        self,
        df_path: str = "./data/svd-rec-ratings-df-test.csv",
        ...
        self.slice_U_k = np.array(
            [
                [-0.288836854063865, -0.882180547612558, -1.894903678810819],
                [0.63987069625696, 0.62553014479506, 1.637035875683824],
                [1.239878749911288, 0.598290692949525, 0.987317344608135],
            ]
        )
        self.slice_V_k = np.array(
            [
                [-0.322567934474643, -0.194226144368913, 0.270272345422909],
                [0.050056569696058, 0.036580660973925, 0.313574856965127],
                [0.572301244929592, 1.318040758707676, -0.336799937534724],
            ]
        )
