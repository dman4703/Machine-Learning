...
2. Create a conda environment from the .yml files provided in `/environment` folder:
    ...
    - Use the command: `conda env create -f environment/ml_hw4_env_<OS>.yml`
...
3. Activate the conda environment:
    - Use the command: `conda activate ml_hw4`
    - You should see (ml_hw4) beside your cursor where (base) was before.
